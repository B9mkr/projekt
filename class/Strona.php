...
class Strona
{
    ...
    function create_header()
    {
		...
		//         <a class="social-link social-link-fb" href="https://www.facebook.com" title="Facebook" target="_blank" rel="noopener">
		//         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M19 6h5V0h-5c-3.86 0-7 3.14-7 7v3H8v6h4v16h6V16h5l1-6h-6V7c0-.542.458-1 1-1z"/></svg></a>
    ...
    {
        $footer='<footer class="site-footer outer"><div class="site-footer-content inner"><section class="copyright">';

	$footer.='<a href="?strona=glowna">GLÓWNA</a> &copy; 2020';

	$footer.='</section><nav class="site-footer-nav">';

	//$footer.='<a href="?strona=glowna">Ostatnie posty</a>';
	$footer.='<a href="?strona=post&amp;this_post=74"><img src="https://img.shields.io/badge/MAIN-Semestr6-blue.svg?style=flat" alt=""></a>';
	//$footer="<a href=\"https://www.facebook.com\" target=\"_blank\" rel=\"noopener\">Facebook</a>";
	//$footer.='<a href="https://twitter.com" target="_blank" rel="noopener">Twitter</a>';

	$footer.='</nav></div></footer>:';
